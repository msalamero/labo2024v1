...
PARAM <- list()
PARAM$dataset <- "C:/Lab_Impl1/datasets/dataset_pequeno.csv"
PARAM$experimento <- "wCA5050"
...
# Obtiene la ruta del directorio del archivo .R en ejecución
script_directory <- dirname(rstudioapi::getSourceEditorContext()$path)

# Establece el directorio de trabajo al directorio del archivo .R
...
dir.create(paste0("C:/Lab_Impl1/exp/", PARAM$experimento, "/"), showWarnings = FALSE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("C:/Lab_Impl1/exp/", PARAM$experimento, "/"))
