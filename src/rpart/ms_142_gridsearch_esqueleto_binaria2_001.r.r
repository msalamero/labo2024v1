...
PARAM$semillas <- c(434411, 889891, 126517, 910031, 686911)
...
ArbolEstimarGanancia <- function(semilla, param_basicos) {
  ...
  #MS-- Ahora deberia ser de dos columnas... 
...
# muestro la cantidad de elementos en clase ternaria
dataset[, .N, clase_ternaria]
#genero la clase binaria combinando baja+1 y continua
...
archivo_salida <- "./exp/HT2020/gridsearch_clasebinaria.txt"
...
for (vmax_depth in c(4,5,6,7,8,9, 10)) {
  for (vmin_split in c(1200,1000, 800, 600, 400, 200, 100)) {
    for(vmin_bucket in c(8,16,32,vmin_split/2,vmin_split/3,vmin_split/4,vmin_split/5)){
      for(vcp in c(-1,-0.9,-0.7,-0.5,-0.3,-0.1,0)){
